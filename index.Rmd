...
### Data 
```{r}
stats=read_csv("data/data_mapa.csv")
stats$PN20 <- NULL
names(stats)=c("Código","País","Proporción de mujeres", "Fuente")
stats %>%
...
### Data 
```{r}
stats=read_csv("data/Ini_vd.csv")
stats$Link <- paste0("<a href='",stats$link,"'>",stats$link,"</a>")
stats$link <- NULL
...
stats=read_csv("data/data_mapa.csv")
stats$PM20 <- NULL
names(stats)=c("Código","País","Proporción de Niños", "Fuente")
stats %>%
  DT::datatable(escape = FALSE,
    filter = "top", 
    extensions = c(
